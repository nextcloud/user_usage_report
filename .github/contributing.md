...
* This repository ([User usage report](https://github.com/nextcloud/user_usage_report/issues)) is *only* for issues within this app.
...
[template]: https://raw.github.com/nextcloud/user_usage_report/master/.github/issue_template.md
